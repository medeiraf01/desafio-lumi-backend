...
export class DashboardController {
  ...
  @ApiResponse({
    status: 200,
    description: 'Dados para o dashboard retornado com sucesso',
  })
  ...
  @ApiQuery({
    name: 'dataInicio',
    required: false,
    description: 'Data inicial para filtrar (formato: MM/YYYY)',
  })
  @ApiQuery({
    name: 'dataFim',
    required: false,
    description: 'Data final para filtrar (formato: MM/YYYY)',
  })
  getDashboardData(
